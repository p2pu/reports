          ...
          return this.each(function() {
               ...
               function getTipueSearch(start, replace)
               {
                    ...
                    else
                    {
                         if (show_stop)
                         {
                              out += '<div id="tipue_search_warning_head"><h3>Sorry</h3> We could not find what you are looking for...</div><div id="tipue_search_warning">Common words are largely ignored</div>';
                         }
                         else
                         {
